            ...
            <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="portfolio-info">
                        <h3>Monitoria e avaliação de projectos</h3>
                        <p style="text-align: justify">Realizamos actividades
                             de monitorias de implementação de projectos e
                              negócios através de sistemas de monitorias inteligentes
                               e modernos, capazes de fornecer informações fidedignas
                                sobre o avanço das actividades, baseados na avaliação
                                 de dados, resultados e mecanismos de implementação das
                                  actividades, tal como avaliação e melhoramento de relatórios
                                   das organizações, mapeamento de boas praticas e lições
                                    aprendidas em Projectos e negócios, comunicados de
                                 imprensa e documentos de diversa índole de interesse do parceiro.     
                        </p>
                    </div>
                </div>
