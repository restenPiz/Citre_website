        ...
        <section class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Detalhes do Serviços</h2>
                    <ol>
                        <li><a href="/">Inicio</a></li>
                        <li><a href="{{route('firstService')}}">Serviços</a></li>
                    </ol>
                </div>
            ...
            <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="portfolio-info">
                        <h3>Elaboração de instrumentos institucionais</h3>
                        <p style="text-align: justify">Somos experientes na elaboração de documentos de suporte institucionais,
                             através dos quais dão credibilidade e visibilidade aos parceiros nacionais
                              e internacionais através de elaboração de Plano Estratégico; Plano de Negócio; 
                              Política ou Estratégia de Género; Códigos de Condutas e Deontológicos; Manuais 
                              de Procedimentos Administrativos e Financeiros; Brochuras para Advocacias, Modelos
                               de comunicados, 
                            relatórios institucionais e personalizados e finalmente estratégias de comunicação e 
                            marketing para a visibilidade organizacional);  
                        </p>
                    </div>
                </div>
