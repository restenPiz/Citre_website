...
<head>
    ...
    <title>CITRE - Consultoria de Investigação e Treinamento</title>
...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1><a href="/"><img class="" src="img/logo3.jpg" style="width:25vh;"></a></h1>
    ...
    <main id="main">
                        ...
                        <ul>
                            <li>
                                ...
                                <div style="margin-top:1rem">
                                    <h5>Desenvolvimento Instituicional</h5>
                                </div>
                            </li>
                            <li>
                                <i class="bx bx-images"></i>
                                <div style="margin-top:1rem">
                                    <h5>Provendo diversos Servicos</h5>
                                </div>
                            </li>
                        </ul>
                        <p>
                            A <b>CITRE, E.I</b>, sujeita-se a legislação em vigor na República de Moçambique, outros
                            instrumentos legais internacionais e a normas internas, sendo dentre elas o Código de
                            Conduta Ética e
                            Deontológica, orientado pelos valores de Ética, Qualidade e Inovação
                        </p>
                    </div>
                </div>
        ...
        <section id="services" class="services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Serviços</h2>
                    <h3>Veja os nossos <span>Serviços</span></h3>
                </div>
            ...
            <div class="container" data-aos="zoom-in"><br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="img/team/a1.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="img/team/a6.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="img/team/a7.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="img/team/a9.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="img/team/b1.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="img/team/a5.png" class="img-fluid" alt="">
                    </div>
        ...
        <section id="portfolio" class="portfolio">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Galeria</h2>
                    <h3>Veja a nossa <span>Galeria</span></h3>
                </div>
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-6 ">
                        <iframe class="mb-4 mb-lg-0"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3753.197612081779!2d34.83482961472591!3d-19.83158984037744!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1f2a6b658961e3cb%3A0xc9806ceb9619aa7e!2sCITRE%2CE.I!5e0!3m2!1spt-PT!2smz!4v1677664669263!5m2!1spt-PT!2smz"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Links utilizaveis</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="#hero">Inicio</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="#about">Sobre Nos</a></li>
