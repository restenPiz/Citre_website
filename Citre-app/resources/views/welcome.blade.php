  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">citre24@gmail.com</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+258 872612657 / +258 840320993</span></i>
      </div>
      <div class="social-links d-none d-md-flex align-items-center">
        <a href="https://web.facebook.com/profile.php?id=100076387305813" class="facebook"><i class="bi bi-facebook"></i></a>
      </div>
    </div>
  </section>
